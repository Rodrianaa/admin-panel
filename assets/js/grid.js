...
function toggleFullScreen() {
    // if aval yani samte chap || bara morur gar haye jadid va samte rast bara morur gar haye ghadidmi age bara morus gar haye jadid fght mikhastim bnvisim dg un samte rasti va un else if ha ro nemineveshtim
